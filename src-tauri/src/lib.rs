...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::chat::set_session_auto_approve,
            ...
            commands::stats::get_session_usage,
            ...
            commands::tools::update_plan_items,
            commands::tools::list_session_grants,
            commands::tools::revoke_session_grant,
            ...
            commands::tools::list_session_snapshots,
